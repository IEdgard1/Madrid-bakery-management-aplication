...
--
-- Table structure for table `employee_sch`
--

CREATE TABLE `employee_sch` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `employee_sch`
--
ALTER TABLE `employee_sch`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `employee_sch`
--
ALTER TABLE `employee_sch`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `recipes`
  ...
  ADD CONSTRAINT `recipes_ibfk_2` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredient` (`id`);
COMMIT;
